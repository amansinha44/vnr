        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div className="md:col-span-2">
              <Link to="/" className="flex items-center gap-2 mb-6">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#5a67d8] to-[#8a2387] flex items-center justify-center shadow-md">
                  <span className="text-white font-black text-lg">V</span>
                </div>
                <span className="font-extrabold text-2xl bg-clip-text text-transparent bg-gradient-to-r from-[#5a67d8] to-[#8a2387] tracking-tight">
                  VNR Media
                </span>
              </Link>
              ...
              <div className="flex gap-4">
                {['Twitter', 'LinkedIn', 'Instagram'].map((social, idx) => (
                  <a key={idx} href="#" className="w-10 h-10 rounded-xl bg-white/70 border border-white flex items-center justify-center text-[#5a67d8] hover:bg-[#5a67d8] hover:text-white transition-all duration-300 shadow-sm">
            ...
            <div>
              ...
              <ul className="space-y-4">
                {['About Us', 'Services', 'Portfolio', 'Contact'].map((item, idx) => (
                  <li key={idx}>
                    <Link to={`/${item.toLowerCase().replace(' ', '')}`} className="text-slate-600 hover:text-[#5a67d8] font-semibold text-sm transition-colors">
                      {item}
                    </Link>
                  </li>
                ))}
            ...
            <div>
              ...
              <ul className="space-y-4">
                {['Digital Strategy', 'Performance Ads', 'Social Media', 'Web Design'].map((item, idx) => (
                  <li key={idx}>
                    <Link to="/services" className="text-slate-600 hover:text-[#5a67d8] font-semibold text-sm transition-colors">
                      {item}
                    </Link>
                  </li>
                ))}
          ...
          <div className="pt-8 border-t border-white/60 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6">
              <Link to="/" className="text-slate-500 hover:text-[#5a67d8] text-sm font-medium transition-colors">Privacy Policy</Link>
              <Link to="/" className="text-slate-500 hover:text-[#5a67d8] text-sm font-medium transition-colors">Terms of Service</Link>
            </div>
          </div>
